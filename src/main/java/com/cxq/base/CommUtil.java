...
public class CommUtil {
    ...
    public static Integer datePresent(){
    ...
    public static String parseShortDateTimeYearAndMonth(Date date) {
    	return parseDateTime("yyyy-MM", date);
    }
    ...
    public static boolean matcherMobile(String mobile) {
        ...
        Pattern pattern = Pattern
            .compile("^(13[0-9]|15[012356789]|17[0-9]|18[0-9]|14[0-9])[0-9]{8}$");
     ...
     * 去除“.00”
     */
   public static String removeLastNum(BigDecimal b){
	   if (null == b) {
		   return null;
	   }else {
    ...
    * 页面计算百分比
    */
   public static String percentageCalculation(Object aa, Object bb){

		BigDecimal a = new BigDecimal(aa.toString());
		BigDecimal b = new BigDecimal(bb.toString());
		...
		BigDecimal d = c.setScale(2, RoundingMode.HALF_UP);// 保留两位小数
		// System.out.println("结果是"+d);
		// 下面将结果转化成百分比
		NumberFormat percent = NumberFormat.getPercentInstance();
		percent.setMaximumFractionDigits(2);
		// System.out.println(percent.format(d.doubleValue()));
